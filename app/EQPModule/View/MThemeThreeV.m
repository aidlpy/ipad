...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        NSArray *array = @[@{@"title":@"首页",@"tag":@"0",@"frame":@"{{90,0},{170,90}}"},@{@"title":@"目录1",@"tag":@"1",@"frame":@"{{270,0},{80,40}}"},@{@"title":@"网络犯罪",@"tag":@"4",@"frame":@"{{270,50},{80,40}}"},@{@"title":@"目录2",@"tag":@"2",@"frame":@"{{360,0},{80,40}}"},
                           @{@"title":@"校园暴力",@"tag":@"5",@"frame":@"{{360,50},{80,40}}"},@{@"title":@"青春保护\n守则",@"tag":@"3",@"frame":@"{{450,0},{80,40}}"},@{@"title":@"性侵",@"tag":@"6",@"frame":@"{{450,50},{80,40}}"},@{@"title":@"",@"frame":@"{{540,0},{80,40}}"},@{@"title":@"诈骗",@"tag":@"7",@"frame":@"{{540,50},{80,40}}"},@{@"title":@"",@"frame":@"{{90,100},{80,40}}"},@{@"title":@"",@"frame":@"{{90,150},{80,40}}"},@{@"title":@"",@"frame":@"{{180,100},{80,40}}"},@{@"title":@"",@"frame":@"{{180,150},{80,40}}"},@{@"title":@"",@"frame":@"{{270,100},{80,40}}"},
                           @{@"title":@"",@"frame":@"{{270,150},{80,40}}"},@{@"title":@"",@"frame":@"{{360,100},{80,40}}"},@{@"title":@"",@"frame":@"{{360,150},{80,40}}"},@{@"title":@"",@"frame":@"{{450,100},{80,40}}"},@{@"title":@"",@"frame":@"{{450,150},{80,40}}"},@{@"title":@"",@"frame":@"{{540,100},{80,40}}"},@{@"title":@"",@"frame":@"{{540,150},{80,40}}"}];
