...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        NSArray *array = @[@{@"title":@"首页",@"tag":@"0",@"frame":@"{{90,0},{170,90}}"},@{@"title":@"  生态\n知识科普",@"tag":@"1",@"frame":@"{{270,0},{80,40}}"},@{@"title":@"惠安县院",@"tag":@"5",@"frame":@"{{270,50},{80,40}}"},@{@"title":@" 宪法护航\n蓝蓝泉州湾",@"tag":@"2",@"frame":@"{{360,0},{80,40}}"},
                           @{@"title":@"",@"tag":@"4",@"frame":@"{{360,50},{80,40}}"},@{@"title":@"  联盟\n启动仪式",@"tag":@"3",@"frame":@"{{450,0},{80,40}}"},@{@"title":@"",@"tag":@"6",@"frame":@"{{450,50},{80,40}}"},@{@"title":@"",@"tag":@"7",@"frame":@"{{540,0},{80,40}}"},@{@"title":@"",@"tag":@"8",@"frame":@"{{540,50},{80,40}}"},@{@"title":@"晋江市院",@"tag":@"9",@"frame":@"{{90,100},{80,40}}"},@{@"title":@"",@"tag":@"15",@"frame":@"{{90,150},{80,40}}"},@{@"title":@"石狮市院",@"tag":@"10",@"frame":@"{{180,100},{80,40}}"},@{@"title":@"",@"tag":@"16",@"frame":@"{{180,150},{80,40}}"},@{@"title":@"南安市院",@"tag":@"11",@"frame":@"{{270,100},{80,40}}"},
                           @{@"title":@"",@"tag":@"17",@"frame":@"{{270,150},{80,40}}"},@{@"title":@"丰泽区院",@"tag":@"12",@"frame":@"{{360,100},{80,40}}"},@{@"title":@"",@"tag":@"18",@"frame":@"{{360,150},{80,40}}"},@{@"title":@"泉港区院",@"tag":@"13",@"frame":@"{{450,100},{80,40}}"},@{@"title":@"",@"tag":@"19",@"frame":@"{{450,150},{80,40}}"},@{@"title":@"洛江区院",@"tag":@"14",@"frame":@"{{540,100},{80,40}}"},@{@"title":@"",@"tag":@"20",@"frame":@"{{540,150},{80,40}}"}];
